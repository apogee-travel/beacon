...
// 25 mock flights copied from examples/react-dashboard/src/mocks/data/flights.ts.
// Dates fixed to summer 2025 so the mock data stays predictable across demo sessions.
